          ...
          <div className="my-12 container px-4 lg:ml-20 lg:w-2/1">
            ...
            <div className="my-8">
              ...
              <div className="flex flex-col gap-3 lg:flex-row">
                <div className="flex items-start gap-2 bg-red-100 p-3 border-red-400 border-dashed border-2 rounded-md">
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <p className="text-gray-600">
                      Get 50% off up to INR 150 on all RuPay card* on EventPrime Stream.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 bg-red-100 p-3 border-red-400 border-dashed border-2 rounded-md">
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <p className="text-gray-600">
                      Get 50% off up to INR 150 on all RuPay card* on EventPrime
                      Stream.
                    </p>
                  </div>
                </div>
