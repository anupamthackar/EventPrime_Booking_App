      ...
      <div>
        ...
        <div className="flex flex-col gap-3 lg:hidden">
          ...
          <div className="flex items-center gap-3 md:px-4 md:w-screen text-xl px-4">
            <button
              onClick={rentMoive}
              className="bg-blue-500 w-full py-3 text-white font-semibold rounded-lg px-4 hover:bg-red-500"
            >
              Rent ₹ 149
            </button>
            <button
              onClick={buyMoive}
              className="bg-blue-600 w-full py-3 text-white font-semibold rounded-lg hover:bg-red-500"
            >
              Buy ₹ 599
            </button>
          </div>
